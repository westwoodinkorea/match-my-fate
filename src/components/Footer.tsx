...
const Footer = () => {
  return (
    <footer className="bg-bluegray-900 text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2">
            ...
            <p className="text-bluegray-300 mb-6 max-w-md">
          ...
          <div>
            ...
            <ul className="space-y-2 text-bluegray-300">
        ...
        <div className="border-t border-bluegray-700 pt-8 text-center">
